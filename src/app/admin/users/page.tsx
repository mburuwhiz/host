...
export default function AdminUserManagement() {
  const users = [
    { name: "John Doe", email: "john@twoem.com", role: "SuperAdmin", status: "Active", apps: 12, lastActive: "Just now", org: "TWOEM Eng" },
    { name: "Alice Tech", email: "alice@company.io", role: "Operator", status: "Active", apps: 4, lastActive: "2h ago", org: "Identity.io" },
    { name: "Bob Builder", email: "bob@dev.net", role: "User", status: "Suspended", apps: 1, lastActive: "12d ago", org: "Dev.net" },
    { name: "Charlie Admin", email: "charlie@twoem.com", role: "Admin", status: "Active", apps: 8, lastActive: "5m ago", org: "TWOEM Eng" },
  ]
    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-2 shadow-sm border-primary/10">
            ...
            <CardContent>
                <p className="text-3xl font-headline font-bold text-zinc-900">1,284</p>
            </CardContent>
        </Card>
        <Card className="border-2 shadow-sm border-secondary/10">
            ...
            <CardContent>
                <p className="text-3xl font-headline font-bold text-zinc-900">98.2%</p>
            </CardContent>
        </Card>
        <Card className="border-2 shadow-sm border-emerald-100">
            ...
            <CardContent>
                <p className="text-3xl font-headline font-bold text-zinc-900">14</p>
            </CardContent>
        </Card>
      </div>
              ...
              <div key={i} className="flex flex-col lg:flex-row items-center justify-between p-8 hover:bg-muted/10 transition-colors gap-8">
                <div className="flex items-center gap-6 w-full lg:w-1/3">
                  <Avatar className="h-14 w-14 border-4 border-white shadow-lg">
                    ...
                    <AvatarFallback className="bg-primary/10 text-primary font-bold">{u.name.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                  </Avatar>
                  <div>
