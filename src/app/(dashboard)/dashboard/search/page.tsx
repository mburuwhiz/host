...
export default function GlobalSearchPage() {
  ...
  const results = [
    { type: "App", name: "storefront-api", desc: "Production API on node-04", icon: Rocket, href: "/apps/app-1/overview" },
    { type: "Team", name: "TWOEM Engineering", desc: "Core infrastructure team", icon: Users, href: "/dashboard/teams" },
    { type: "Docs", name: "Custom Domains", desc: "How to setup edge routing", icon: Book, href: "/docs/networking" },
  ]
