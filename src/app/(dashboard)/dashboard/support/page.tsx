...
export default function SupportHubPage() {
  ...
  const tickets = [
    { id: "T-8821", subject: "Build failing on Node-04", status: "Open", time: "2h ago", priority: "High" },
    { id: "T-7192", subject: "Custom domain SSL reverification", status: "Resolved", time: "1d ago", priority: "Medium" },
    { id: "T-6651", subject: "2.5TB partition expansion query", status: "Closed", time: "1w ago", priority: "Low" }
  ]
          ...
          <Card className="border-2">
            <CardHeader className="border-b bg-muted/30">
              <div className="flex justify-between items-start">
                <div>
                  <Badge variant="outline" className="mb-2">T-8821</Badge>
                  <CardTitle className="text-2xl font-headline">Build failing on Node-04</CardTitle>
                </div>
            ...
            <CardContent className="p-8 space-y-8">
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1 bg-muted/30 p-4 rounded-2xl rounded-tl-none border">
                    <p className="text-sm">Hi team, I'm getting a 'partition full' error when deploying my Next.js app on node-04. Can you check my 2.5TB quota?</p>
                    <p className="text-[10px] text-muted-foreground mt-2">Today, 2:15 PM</p>
                  </div>
                </div>

                <div className="flex gap-4 items-start flex-row-reverse">
                  <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xs">
                    TS
                  </div>
                  <div className="flex-1 bg-primary/10 p-4 rounded-2xl rounded-tr-none border border-primary/20 text-right">
                    <p className="text-sm font-bold text-primary mb-1">TWOEM Support (Alice)</p>
                    <p className="text-sm">We've identified a cache overflow on Node-04. I've cleared the build partition for your organization. Please retry the deployment.</p>
                    <p className="text-[10px] text-primary/60 mt-2">Today, 2:27 PM</p>
                  </div>
                </div>
              </div>
